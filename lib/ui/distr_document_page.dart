...
class DistrDocumentPage extends StatefulWidget {
  final bool isNew;
  final String documentGuid;

  DistrDocumentPage({this.isNew, this.documentGuid});

  @override
  _DistrDocumentPageState createState() => _DistrDocumentPageState();
}

class _DistrDocumentPageState extends State<DistrDocumentPage> {
  int _currentIndex = 0;
  double _sum; 
   ...
   if(index==0){
     ...
     if(mistake["error"]){
       ...
       BlocProvider.of<DocumentBloc>(context).add(DocumentSavingEvent(
         ...
         isNew: widget.isNew,
         documentType: DocumentType.Distribution,
 ...
 Future<Map<String,dynamic>> getMistakes() async {
   ...
   if (_selectedAgent == null && _currentPrice==null) {
    ...
    return Scaffold(
        ...
        body:BlocBuilder<DocumentBloc,DocumentState>(
          builder: (context, state) {
            ...
            if(state is DocumentDstrSSuccessOpeningState){
              _currentAgent = state.currentAgent;
              _currentPrice =state.currentPrice;
              ...
              return CustomScrollView(
                slivers: <Widget>[
                  ...
                  SliverList(
                        ...
                        listener: (context, state) {
                          if(state is DocumentDstrSSuccessOpeningState){
                            if(state.productList.length == 0){
                              final snackBar = new SnackBar(content: Text("Сначала нужно оприходовать товар,"),
                   ...
                   _buildDropDownItemWidgetPrice(state.prices,state.currentPrice),
